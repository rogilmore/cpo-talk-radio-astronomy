...
```{r}
#| echo: false
talk_qr <- qrcode::qr_code("https://rick-gilmore.com/cpo-talk-astronomy")
plot(talk_qr)
```
:::
...
![[@hamsci-eclipse-2024-qso-party]](https://hamsci.org/sites/default/files/pages/eclipse_festival/20240408_SEQP_FirstResults.png)
